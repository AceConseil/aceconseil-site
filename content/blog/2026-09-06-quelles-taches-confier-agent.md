...
![Quatre critères qui qualifient une tâche pour un agent IA, quatre qui la disqualifient](assets/quelles-taches-confier-agent.jpg)
...
Vous pouvez faire ce tri seul, sur la liste des [tâches que personne n'a dans sa fiche de poste](/blog/taches-sans-proprietaire) chez vous.
...
Si vous voulez faire passer ce test à une tâche précise chez vous, [appelez-nous](/#contact). Vingt minutes avec Jennifer, cofondatrice. Si la tâche échoue au test, nous vous le dirons, et nous ne vous vendrons rien.
