...
![Facture électronique : les quatorze statuts du cycle de vie, dont quatre obligatoires, et le refus définitif](assets/refus-facture-electronique.jpg)
...
::widget statuts-facture-quatre-gestes::
...
Pour le reste du dispositif, nous avons détaillé ce que fait vraiment le [portail public de facturation](/blog/portail-public-facturation-ce-qu-il-fait-vraiment), ce qu'un [client ne peut pas vous imposer](/blog/facture-electronique-client-ne-peut-pas-imposer), et [ce que vous risquez](/blog/facture-electronique-pas-pret-ce-que-vous-risquez) si vous n'êtes pas encore raccordé.

Si vous voulez que quelqu'un regarde votre boîte de réception avec vous et vous dise en vingt minutes ce qui doit être attribué, [appelez-nous](/#contact). Jennifer, cofondatrice, prend le premier appel. S'il n'y a rien à faire chez vous, nous vous le dirons aussi.
