# Plan éditorial : les 10 premiers articles
...
- Semaine du 10 août (rédigée, vérifiée et relue en double lentille adverse ; 9 problèmes bloquants corrigés avant installation) :
  - lun 10/08 : `2026-08-10-repondre-vite-sans-embaucher.md` **publié** (socle n°10. Couverture « RÉPONSE / 1 H », le sceau portant la thèse contre le folklore des cinq minutes. Widget cochable `test-boucle-reponse` à 10 gestes vérifiables, rétro-lien depuis l'article coût d'une demande perdue du 8/07, liens vers /agents-ia et /strategie-commerciale, pilier le plus affamé depuis le 10 juillet). Titre recentré sur la requête réellement tapée (« réponse automatique WhatsApp ») ; attribution de l'étude Harvard Business Review de mars 2011 rétablie contre le folklore des cinq minutes ; calendrier du démarchage téléphonique du 11 août corrigé et vérifié.
  - mer 12/08 : `2026-08-12-facture-electronique-artisan-batiment.md` **publié** (renfort du fil facture : une facture de matériaux suivie du négoce au paiement. Couverture « RECEVOIR / 1.09 », accordéon `quatre-appels-avant-septembre` donnant les phrases exactes à prononcer, rétro-liens depuis les articles du 5/08 et du 29/07). Corrections avant publication : la contradiction avec l'article du 5/08 est levée en rétablissant la facture test comme contrôle le plus solide ; l'affirmation « aucune émission avant 2027 » est restreinte aux clients privés, les marchés publics passant par Chorus Pro depuis le 1er janvier 2020 (articles L2192-1 et L2192-5 du code de la commande publique, vérifié) ; la prémisse sur les négoces est nuancée, une enseigne nationale pouvant être un groupement d'indépendants de taille PME qui n'émettra qu'en 2027 ; les ventes aux particuliers sont rattachées au e-reporting de septembre 2027 ; deux artefacts de relecture collés dans le corps ont été retirés.
  - ven 14/08 : `2026-08-14-digitaliser-tpe-seine-et-marne.md` **publié** (socle n°8, référencement local. Couverture « CHÈQUE / CLOS », widget cochable `checklist-dossier-numerique-77` à 9 points, rétro-lien depuis l'article IA en PME du 3/08, 11 liens officiels datés de la vérification). Corrections avant publication : Val d'Europe est le secteur IV de Marne-la-Vallée et Serris une de ses communes, la formulation « à quelques minutes de Marne-la-Vallée » était fausse ; la loi NOTRe du 7 août 2015 réserve les aides directes à la Région, les chambres consulaires n'en accordent pas, les communes et intercommunalités gardent l'immobilier d'entreprise et le Département n'intervient que par délégation ; chiffres de la CMA datés de son recensement 2024 ; tarifs des chambres attribués à leurs catalogues et relevés à date ; Pack IA ramené à un ordre de grandeur ; un artefact de relecture retiré du corps.
  - Posts LinkedIn : section « Semaine 5 » de `docs/POSTS_LINKEDIN.md` (lun Mateusz, mer Jennifer, ven Mateusz).
- Semaine du 17 août :
  - mer 19/08 : `2026-08-19-facture-electronique-commerce-proximite.md` **publié** (renfort du fil facture, cas « commerce » prévu au plan d'actualité après l'artisan du bâtiment du 12/08. Angle : le commerçant qui vend aux particuliers se croit hors sujet, il l'est sur ses ventes jusqu'en 2027 mais pas du tout sur ses achats. Couverture « ACHATS / 2026 », accordéon `cinq-situations-au-comptoir`, rétro-liens depuis les articles du 16/07 et du 12/08). Corrections avant publication : la suppression du régime simplifié d'imposition au 1er janvier 2027 était présentée comme incertaine alors qu'elle est votée, elle est déplacée et affirmée ; un tableau officiel décrit n'existait pas sous cette forme ; un mécanisme de rattrapage de TVA était inventé, remplacé par un point ouvert assumé ; la facture simplifiée sous 150 euros a été ajoutée ; « obligation » distinguée d'« interdiction » pour les fournisseurs qui basculent par anticipation.
  - lun 17/08 : `2026-08-17-ai-act-report-calendrier-tpe.md` **publié** (actualité, pilier /formation-ia. Le règlement (UE) 2026/1744 du 24 juillet, en vigueur depuis le 27 juillet, reporte au 2 décembre 2027 les obligations de l'annexe III. Angle : le contresens à éviter, un dirigeant qui conclut qu'il n'a plus rien à faire. Couverture « ANNEXE III / 2027 », widget cochable `perimetre-ia-apres-report` à 9 points démontrables, mises à jour datées ajoutées aux articles du 14 et du 21 juillet, qui pointent tous deux vers celui-ci). La relecture adverse a corrigé deux points bloquants : le régime de sanctions s'applique depuis le 2 août 2025 et non 2026, seule la surveillance du marché arrivant le 2 août 2026 ; et l'omnibus installe une troisième date, le 2 décembre 2026, pour deux nouvelles pratiques interdites et le marquage des contenus générés.
...
- Requêtes visées : relance devis artisan, relancer un devis sans réponse, relance automatique devis
- Intention : douleur n° 1 de la cible, très proche de l'achat
- Plan : le coût du devis non relancé (renvoyer vers le calculateur de la home) · pourquoi on ne relance pas (pas le temps, peur de déranger) · à quoi ressemble une bonne séquence de relance (délais, ton, exemple de message) · comment l'automatiser sur vos outils existants · ce que ça change dans une semaine type
- Maillage : /automatisation, /#offre-site si le devis vient du site
- CTA : « Vérifier ce que vos devis non relancés vous coûtent » → /#preuves

## 2. Un agent IA dans une entreprise artisanale : ce que ça fait vraiment, heure par heure
- Slug : `agent-ia-artisan-concret`
- Requêtes : agent IA artisan, secrétariat automatique artisan, IA petite entreprise exemple
- Intention : découverte, fort potentiel de citation par les IA (répond à « à quoi sert un agent IA pour un artisan ? »)
- Plan : une journée type sans agent · la même journée avec (reprendre le fil d'activité du hero : 22 h 41, demande qualifiée, réponse envoyée...) · ce que l'agent ne fait pas (honnêteté = différenciation) · sur quels outils ça se branche · par où commencer
- Maillage : /agents-ia, /#methode

## 3. Combien coûte une demande client perdue ? La méthode de calcul complète
- Slug : `cout-demande-perdue-calcul`
- Requêtes : coût client perdu, manque à gagner devis, combien coûte un prospect perdu
- Intention : contenu « citable » par excellence (méthode + formule + exemple chiffré générique)
- Plan : la formule (demandes × 52 × taux × valeur) · trois profils types calculés (plombier, cabinet de conseil, commerce) en exemples génériques, pas en références clients · les coûts invisibles (réputation, bouche-à-oreille) · comment mesurer chez soi en une semaine
- Maillage : /#preuves (calculateur), /strategie-commerciale

## 4. Facturation, planning, messagerie : en finir avec la triple saisie
- Slug : `automatiser-saisie-outils-tpe`
- Requêtes : synchroniser facturation planning, automatisation administrative TPE, connecter ses outils artisan
- Plan : le vrai coût des soirées administratives · cartographier ses outils en 30 minutes · ce qui se connecte facilement (et ce qui ne vaut pas le coup) · exemple de flux devis → facture → relance · garder la main : l'humain décide, la machine exécute
- Maillage : /automatisation

## 5. Site internet d'artisan : les 7 éléments qui transforment une visite en appel
- Slug : `site-artisan-elements-qui-convertissent`
- Requêtes : site internet artisan, créer site artisan efficace, site vitrine qui convertit
- Intention : soutient directement l'offre 499
- Plan : liste des 7 éléments (numéro visible, preuve locale, photos réelles, formulaire court, vitesse, avis, appel à l'action clair) · les erreurs classiques des sites de template · combien de temps ça prend · check-list finale téléchargeable en clair dans l'article
- Maillage : /sites-web, /#offre-site

## 6. Fiche Google Business : le levier n° 1 des artisans locaux, bien au-dessus du site
- Slug : `fiche-google-business-artisan`
- Requêtes : fiche Google artisan, Google Business Profile TPE, avis Google entreprise locale
- Intention : forte recherche, position d'expert local
- Plan : pourquoi la fiche passe avant le site (88 % des clients lisent les avis) · remplir chaque champ, dans l'ordre · obtenir des avis sans harceler (le bon moment, le bon message) · répondre aux avis, y compris négatifs · relier fiche et site
- Maillage : /visibilite-prospection

## 7. IA en PME : par où commencer sans se faire vendre du rêve
- Slug : `ia-pme-par-ou-commencer`
- Requêtes : IA PME par où commencer, adopter IA petite entreprise, formation IA équipe
- Plan : les 3 usages qui paient dès le premier mois · les pièges (abonnements empilés, outils gadgets, dépendance à un prestataire) · la méthode du premier chantier unique · former l'équipe sur SES cas, pas sur des démos · questions à poser à tout prestataire (transparence = confiance)
- Maillage : /formation-ia, /agents-ia
...
- Auteur de référence : Jennifer (10 ans VEFA et marchés publics)

## 10. Répondre en 5 minutes même en chantier : WhatsApp, email et standard sans embaucher
- Slug : `repondre-vite-sans-embaucher`
- Requêtes : réponse automatique WhatsApp artisan, standard automatique TPE, répondre aux clients en déplacement
- Plan : la fenêtre des 5 minutes (le premier qui répond prend le client) · trier l'urgent du reste automatiquement · exemples de réponses qui qualifient sans robotiser · brancher WhatsApp / email / téléphone ensemble · les limites (quand l'humain doit reprendre la main)
- Maillage : /agents-ia, /#preuves
